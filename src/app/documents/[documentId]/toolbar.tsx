    ...
    <div className="flex items-center gap-x-2">
      ...
      {isEditing ? (
        <input
          ...
          className="h-7 w-10 text-sm-center shrink-0 border border-neutral-400 rounded-sm bg-transparent focus:outline-none focus:ring-0"
        />
      ) : (
        <button
          type="button"
